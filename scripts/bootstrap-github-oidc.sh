      ...
      Statement: [
        ...
        },
        {
          ...
          Action: [
            ...
            "cognito-idp:CreateUserPool*", "cognito-idp:DeleteUserPool*", "cognito-idp:UpdateUserPool*", "cognito-idp:SetUserPoolMfaConfig", "cognito-idp:CreateGroup", "cognito-idp:DeleteGroup", "cognito-idp:UpdateGroup", "cognito-idp:CreateResourceServer", "cognito-idp:DeleteResourceServer", "cognito-idp:UpdateResourceServer", "cognito-idp:TagResource", "cognito-idp:UntagResource",
